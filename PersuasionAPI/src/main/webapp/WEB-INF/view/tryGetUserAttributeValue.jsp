...
<title>Try PersuasionAPI: Get User Attribute Value</title>
</head>
<body role="document">
	...
	<div class="container theme-showcase" role="main">
		<div class="page-header">
			<h1>Get User Attribute Value</h1>
		</div>
			...
			<div class="panel-body">
				<div class="col-sm-12">
					<form role="form form-horizontal" id="requestForm">
						...
						<div class="form-group row">
							<label for="attributeName" class="control-label col-sm-2">Attribute Name:</label>
							<div class="col-sm-4"><input type="text" class="form-control input-sm" id="attributeName"></div>
						</div>
		...
		<div id="success-response-panel" class="panel panel-default aria-hidden">
			...
			<div class="panel-body">
				<table class="table table-striped table-bordered table-nonfluid">
					...
					<tr><th>Attribute Name</th><td id="response-attributeName"></td></tr>
					<tr><th>Attribute Value</th><td id="response-attributeValue"></td></tr>
				</table>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		$('#requestForm').submit(function(event) {
			...
			$.ajax({
				'type': 'POST',
				'url': webContextRoot + '/user/attribute/getUserAttributeValue',
				...
				'success': function(data) {
					if(data.responseType=='SUCCESS') {
						...
						$('#response-attributeName').text(responseData.attributeName);
						$('#response-attributeValue').text(responseData.value);
